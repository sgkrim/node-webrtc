 ...
 * @deprecated
 */
RTCPeerConnection.prototype.attachAudioEncodedSink = function attachAudioEncodedSink(trackId, callback) {
  return this._pc.attachRawSink(trackId, callback);
};

RTCPeerConnection.prototype.attachAudioSink = function attachAudioSink(trackId, callback) {
  return this._pc.attachAudioSink(trackId, callback);
};

RTCPeerConnection.prototype.attachEncodedVideoSink = function attachEncodedVideoSink(trackId, callback) {
  return this._pc.attachEncodedVideoSink(trackId, callback);
};

RTCPeerConnection.prototype.attachRtpSink = function attachRawSink(trackId, callback) {
  return this._pc.attachRtpSink(trackId, callback);
};
 ...
 * @returns {*}
 */
RTCPeerConnection.prototype.attachRtpSink = function attachRtpSink(trackId, payloadType, callback) {
  return this._pc.attachRtpSink(trackId, payloadType, callback);
};
 ...
 * @returns {*}
 */
RTCPeerConnection.prototype.attachFrameSink = function attachFrameSink(trackId, callback) {
  return this._pc.attachFrameSink(trackId, callback);
};
 ...
 * @returns {*}
 */
RTCPeerConnection.prototype.getPayloadTypes = function getPayloadTypes() {
  return this._pc.getPayloadTypes();
};
 ...
 * @returns {*}
 */
RTCPeerConnection.prototype.getActiveCodecs = function getActiveCodecs() {
  return this._pc.getActiveCodecs();
};
